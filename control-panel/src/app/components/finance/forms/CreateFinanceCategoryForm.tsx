...
const FinanceCategoryFormModal: React.FC<CategoryFormModalProps> = ({
  onClose,
  ...
  const handleAddCategory = async () => {
    ...
    try {
      await addOption({ name: categoryName, type: 'finance_categories' }); // Use the correct type
...
export default FinanceCategoryFormModal;
