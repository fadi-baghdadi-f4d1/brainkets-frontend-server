...
const CreateProjectForm: React.FC<{ onClose: () => void }> = ({ onClose }) => {
    ...
    <section>
      <div className="fixed inset-0 flex items-end justify-end">
        <div className="w-[750px] h-screen bg-white shadow-md overflow-y-auto relative custom-scrollbar">
          <div className="flex justify-between items-center h-[70px] px-2 md:px-[30px]">
            ...
            <h1 className="text-[20px] font-bold">Create Project</h1>
            <button
          ...
          <div className="bg-[#F4F4F4] px-2 md:px-[30px] py-[15px] w-full h-full">
            <form className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-black font-bold mb-1">Departments <span className='text-[#FF0000]'>*</span></label>
                <div className="flex cursor-pointer">
      ...
      <label className="switch ml-3 cursor-pointer mt-1">
        ...
        <span className="slider"></span>
              ...
              <div>
                <label className="block text-black font-bold mb-1">Start Date <span className='text-[#FF0000]'>*</span></label>
              ...
              <div>
                <label className="block text-black font-bold mb-1">Due Date <span className='text-[#FF0000]'>*</span></label>
                <div className="flex items-center">
                  <input type="date" 
                    className="w-full px-2 py-2 border rounded-md" 
                    value={dueDate} 
              ...
              <div>
                <label className="block text-black font-bold mb-1">Currency <span className='text-[#FF0000]'>*</span></label>
                <select
              ...
              <div>
                <label className="block text-black font-bold mb-1">Project Budget <span className='text-[#FF0000]'>*</span></label>
                <input type="text" 
              ...
              <div className="col-span-2">
                <label className="block text-black font-bold mb-1">Project Description <span className='text-[#FF0000]'>*</span></label>
