...
var SelectCategoryForm = function (_a) {
        ...
        var fetchCategories = function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, GetOptionsApi_1.getOptions('project_categories', 1, searchQuery)];
                    case 1:
                        data = _a.sent();
    ...
    react_1.useEffect(function () {
        // Update selected category whenever the category list or selectedCategoryId changes
        if (selectedCategoryId !== undefined) {
            var category = categories.find(function (c) { return c.id === selectedCategoryId; });
    ...
    return (react_1["default"].createElement("div", { className: "bg-[#F4F4F4] h-screen shadow-lg w-full max-w-md flex flex-col" },
        ...
        react_1["default"].createElement("div", { className: "flex-grow overflow-y-auto p-4 custom-scrollbar" }, categories.map(function (category, index) { return (react_1["default"].createElement("div", { key: category.id, className: "relative flex items-center border-b-[#C4C4C4] border-b-2 justify-between mb-2 px-2" },
            react_1["default"].createElement("div", { className: "flex items-center w-full py-2 cursor-pointer " + ((selectedCategory === null || selectedCategory === void 0 ? void 0 : selectedCategory.id) === category.id ? 'bg-[#e0e0e0]' : ''), onClick: function () { return handleCategorySelect(category.id, category.name); } },
                react_1["default"].createElement("span", { className: 'font-medium' }, category.name)),
            react_1["default"].createElement("div", { className: "relative" },
                react_1["default"].createElement(EditDeleteDropdown_1["default"], { type: "project_categories", entityId: category.id, entityName: category.name, onclick: function () { return handleDropdownToggle(index); } })))); }))));
};
