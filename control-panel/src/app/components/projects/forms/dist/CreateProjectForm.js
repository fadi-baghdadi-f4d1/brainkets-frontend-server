...
var CreateProject_1 = require("../../../services/projects/CreateProject");
...
var CreateProjectForm = function (_a) {
    ...
    var handleSave = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!name) {
                        react_toastify_1.toast.error('Project Name is required.');
                        return [2 /*return*/];
                    }
                    if (!status) {
                        react_toastify_1.toast.error('Status is required.');
                        return [2 /*return*/];
                    }
                    ...
                    if (!startDate) {
                        react_toastify_1.toast.error('Start Date is required.');
                        return [2 /*return*/];
                    }
                    if (!dueDate) {
                        react_toastify_1.toast.error('Due Date is required.');
                        return [2 /*return*/];
                    }
                    // Ensure budget is a positive number
                    if (budget <= 0) {
                        react_toastify_1.toast.error('Budget must be greater than 0.');
                        return [2 /*return*/];
                    }
                    // Ensure description is not empty
                    if (!description) {
                        react_toastify_1.toast.error('Project Description is required.');
                        return [2 /*return*/];
                    }
                    _a.label = 1;
                case 1:
                    ...
                    return [4 /*yield*/, CreateProject_1.createProject(payload)];
                case 2:
                    // Call your API or service to save the project data
                    _a.sent();
                ...
                case 3:
                    error_2 = _a.sent();
                    console.error('Failed to create project', error_2);
        ...
        react_1["default"].createElement("div", { className: "fixed inset-0 flex items-end justify-end" },
            react_1["default"].createElement("div", { className: "w-[750px] h-screen bg-white shadow-md overflow-y-auto relative custom-scrollbar" },
                react_1["default"].createElement("div", { className: "flex justify-between items-center h-[70px] px-2 md:px-[30px]" },
                    ...
                    react_1["default"].createElement("h1", { className: "text-[20px] font-bold" }, "Create Project"),
