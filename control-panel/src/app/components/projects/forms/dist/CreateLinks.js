...
var react_toastify_1 = require("react-toastify"); // Import toast
var CreateLinks = function (_a) {
    ...
    var handleSave = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    react_toastify_1.toast.success('Link added successfully!'); // Show success toast
                    onSave(title, url);
                    toggleModal();
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
                    react_toastify_1.toast.error('Failed to add link.'); // Show error toast
    ...
    return (react_1["default"].createElement("div", { className: "bg-[#F4F4F4] h-screen shadow-lg w-full max-w-md flex flex-col" },
        react_1["default"].createElement("div", { className: "bg-white px-6 flex items-center h-16 p-2 w-full" },
            ...
            react_1["default"].createElement("h2", { className: "flex-grow text-center ml-8 text-xl font-bold" }, "Create Links"),
        ...
        react_1["default"].createElement("div", { className: "w-full max-w-md space-y-4 p-4" },
            react_1["default"].createElement("div", { className: "mb-4 mx-4" },
                ...
                react_1["default"].createElement("input", { className: "w-full border " + (errors.title ? 'border-red-500' : 'border-gray-300') + " rounded-lg p-2", type: "text", id: "title", placeholder: "Title", value: title, onChange: function (e) { return setTitle(e.target.value); }, ref: linkInputRef }),
                errors.title && react_1["default"].createElement("p", { className: "text-red-500 text-sm mt-1" }, errors.title)),
            react_1["default"].createElement("div", { className: "mb-4 mx-4" },
                react_1["default"].createElement("label", { className: "block text-black font-semibold mb-2", htmlFor: "url" }, "URL"),
                react_1["default"].createElement("input", { className: "w-full border " + (errors.url ? 'border-red-500' : 'border-gray-300') + " rounded-lg p-2", type: "text", id: "url", placeholder: "URL", value: url, onChange: function (e) { return setUrl(e.target.value); } }),
                errors.url && react_1["default"].createElement("p", { className: "text-red-500 text-sm mt-1" }, errors.url)))));
};
